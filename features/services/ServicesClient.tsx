        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              We follow a structured approach to ensure every project meets our high standards of
              quality.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 text-left">
            {[
              ...
              },
              {
                ...
                title: 'Creation',
                description:
                  'Our team brings your vision to life with expert craftsmanship and attention to detail.',
              },
              {
                step: '04',
                title: 'Delivery',
                description:
                  "We deliver the final product and ensure you're completely satisfied with the results.",
              },
            ].map((process, index) => (

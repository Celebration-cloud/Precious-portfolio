...
import { contactSchema, ContactInput } from '../../domain/entities/contact';
          ...
          <div className="grid lg:grid-cols-2 gap-16 text-left">
            ...
            >
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-8">
                We&apos;re here to help bring your creative vision to life. Reach out to us through any of the following channels or fill out the form.
              </p>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-white dark:bg-slate-800 border ${
                          errors.name ? 'border-red-500 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:ring-blue-500'
                    ...
                    <div>
                      ...
                      <select
                        ...
                        {...register('service')}
                        className={`w-full px-4 py-3 bg-white dark:bg-slate-800 border ${
                          errors.service ? 'border-red-500 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:ring-blue-500'
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={5}
                        className={`w-full px-4 py-3 bg-white dark:bg-slate-800 border ${
                          errors.message ? 'border-red-500 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:ring-blue-500'
